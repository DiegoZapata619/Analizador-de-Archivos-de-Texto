...
# Lee el archivo y busca las coincidencias. Almacena las coincidencias en una lista con el nombre del documento final.
with open(archivo, "r", encoding="utf-8") as f:
    contenido = f.read()
coincidencias = re.findall(expresionRegular, contenido,re.IGNORECASE) # Agrega re.IGNORECASE para hacer la búsqueda insensible a mayúsculas y minúsculas
if coincidencias:
